  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new News" do
        expect {
          news :create, {:news => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved news as @news" do
        ...
        news :create, {:news => { "title" => "invalid value" }}, valid_session
        assigns(:news).should be_a_new(News)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested news" do
        ...
        News.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => news.to_param, :news => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the news as @news" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        News.any_instance.stub(:save).and_return(false)
        put :update, {:id => news.to_param, :news => { "title" => "invalid value" }}, valid_session
        assigns(:news).should eq(news)
      end
